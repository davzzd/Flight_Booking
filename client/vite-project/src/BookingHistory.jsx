        ...
        bookings.map((booking) => (
          <div key={booking.id} className="ticket">
            <div className="ticket-details">
              ...
              {/* Safely check if seatIds exists and is an array */}
              <p>Seats: {booking.seatIds ? booking.seatIds.join(', ') : 'N/A'}</p>
      ...
      {bookings.length === 0 ? (
        ...
        bookings.map((booking) => (
          <div key={booking.id} className="ticket">
            <div className="ticket-details">
              <p>Flight ID: {booking.flightId}</p>
              <p>Seats: {booking.Seats ? booking.Seats.map(seat => seat.seatNumber).join(', ') : 'N/A'}</p>
